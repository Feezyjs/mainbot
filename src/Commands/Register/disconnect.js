...
exports.run = async (Moderation, message, args) => {
    ...
    message.channel.send(new MessageEmbed().setColor("RANDOM").setDescription(`${Member} üyesi başarıyla \`${Member.voice.channel.name}\` ses kanalından çıkarıldı!`)).then(x => x.delete({timeout: 10000}));
