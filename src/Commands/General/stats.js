...
const { StatsModel, InviteModel, LevelModel } = require("../../Helpers/models.js");
...
exports.run = async (Moderation, message, args) => {
    ...
    let kanal = ["797482228148994089"]
if(!kanal.includes(message.channel.id)) return message.reply("Lütfen sadece <#797482228148994089> kanalında komutlarınızı kullanınız.").then(m => m.delete(10000))
